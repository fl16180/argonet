...
STATES_DIR = 'C:/Users/fredl/Documents/repos/state-flu/results'
...
final = final.reindex(['GFT','AR52','ARGO(gt)','ARGO(gt,ath)','Net','ARGONet'], level=2)
...
final.loc[final['Model'] == 'ARGO(gt,ath)', 'Model'] = 'ARGO'
